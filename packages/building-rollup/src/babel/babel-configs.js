...
const createBabelConfigRollupBuild = developmentMode => ({
  ...
  plugins: [
    // rollup doesn't support optional chaining yet, so we compile it during
    // input
    ...
    // plugins that aren't part of @babel/preset-env should be applied regularly
    // in the rollup build phase

 ...
 * @typedef {import('lit-html/lib/shady-render').ShadyRenderOptions}
 * ShadyRenderOptions
 * @typedef {function(TemplateResult, Element|DocumentFragment|ShadowRoot,
 * ShadyRenderOptions): void} RenderFunction
 */
...
/**
 * Transforms an array of TemplateResults or arrays into another one with
 * resolved scoped elements
 *

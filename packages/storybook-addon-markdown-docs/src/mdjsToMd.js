...
/**
 * Override image to make it closing `<img src="" />` as otherwise the jsx
 * parser throws
 *
 * @param {*} h
 * @param {*} node
...
/**
 * Override line break to make it closing `<br />` as otherwise the jsx parser
 * throws Can't use 'break' as a function name as it is a reserved javascript
 * language name
 *
 * @param {*} h
 * @param {*} node

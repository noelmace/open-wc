...
After creating our class we can associate it with a tagname by defining it in
...
This shadow root is a special type of DOM node which encapsulates the elements

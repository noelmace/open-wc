...
describe('spread', () => {
  ...
  it('can render undefined', async () => { renderSpread(undefined); });

  it('can render null', async () => { renderSpread(null); });
  ...
  describe('boolean attributes', () => {
    it('sets boolean attributes on an element', async () => {
      const element =
          renderSpread({'?foo' : true, '?lorem' : false, '?x' : true});
  ...
  describe('event listeners', () => {
    it('adds event listeners to an element', async () => {
      ...
      const element = renderSpread(
          {'@my-event-a' : eventHandlerA, '@my-event-b' : eventHandlerB});
    ...
    it('can change event listeners in subsequent renders, deregistering the earlier listener',
       async () => {
         const eventHandlerA = stub();
         const eventHandlerB = stub();
